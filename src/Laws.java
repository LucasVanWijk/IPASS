public class Laws {
    ...
    public static double calc_Force_Velocity(double velocity, double mass_sat, double distance){

        return (mass_sat * Math.pow(velocity, 2)) / distance;
    }
    public static double calc_Force(double mass_planet, double mass_sat, double distance){

        return (mass_planet * mass_sat * gravitational_constant) / Math.pow(distance,2);
    }
    ...
    public static double calc_mass_plan(double velocity, double distance){
        return (Math.pow(velocity,2) * distance) / gravitational_constant;
    }
